...
$password = "81250767Pl";
        ...
        echo ("<div><H2>CADASTRO DO BLOCO D DO PROFESSOR CONCLUIDO</H2></div>");
    ...
    $RECEBEH = $RECEBEHORA;
       ...
       $STMT = $db -> prepare('INSERT INTO fucapi1.blocod (nome_professor, sala, date1, date2, datad) VALUES (:NOMEPR, :SALAS, :DATE1D, :DATE2D, :HORAH);');
